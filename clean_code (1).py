...
w2 = Label(root, justify=LEFT, text="A Project by Team 14", fg="white", bg="black")
w2.config(font=("Algerian",30))
w2.grid(row=2, column=0, columnspan=2, padx=100)

# labels
NameLb = Label(root, text="Name of the Patient", fg="skyblue", bg="black")
NameLb.config(font=("Georgia",15))
